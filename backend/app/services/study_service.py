...
DEFAULT_TRANSLATION_CONTENT: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "consent_description": "### Confirmation of Understanding\nBy checking the box below, you confirm that you have read the study objectives and process described on the home page. You understand that:\n* This task involves sorting statements to model your personal point of view.\n* There are no right or wrong answers.\n\n### Confidentiality and Data Protection\n* **Anonymity:** Your participation is anonymous. Your responses will be associated with a code and will not be linked to your identity in any report or publication.\n* **Data Usage:** Collected data will be analyzed collectively to identify shared perspectives (factors).\n* **Quotes:** Written comments provided during the post-sort phase may be quoted anonymously to illustrate these viewpoints.\n\n### Voluntary Participation\nParticipation is entirely voluntary. You reserve the right to interrupt the sorting process and close the browser at any time without penalty. If you withdraw before submission, your partial data will not be retained.",
