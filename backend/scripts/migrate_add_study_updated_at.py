    ...
    async with engine.begin() as conn:
        ...
        if dialect == "sqlite":
            ...
            if "updated_at" in columns:
                ...
                await conn.execute(text("ALTER TABLE studies ADD COLUMN updated_at DATETIME DEFAULT CURRENT_TIMESTAMP"))
            ...
            if result.scalar():
                ...
                print("Adding column 'updated_at'...")
                await conn.execute(text("ALTER TABLE studies ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP"))
                print("Column 'updated_at' added successfully.")
