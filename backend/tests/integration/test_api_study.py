"""Integration tests for the Study API."""
...
async def test_get_study_optional_fields_and_statement_fallbacks(client, db):
    ...
    st1_en = StatementTranslation(
        statement_id=s1.id, language_code="en", text="Text EN"
    )
    db.add(st1_en)
