...
from app.models import Statement, StatementTranslation, Study, StudyTranslation


async def update_study():
    """Update study data from JSON file while preserving existing relationships."""
    ...
    async with SessionLocal() as session:
        ...
        await session.execute(
            delete(StudyTranslation).where(StudyTranslation.study_id == study.id)
        )
