...
|------|------|---------|-------|
| `scanners/wave-1/gitleaks.json` | gitleaks | 8.18.4 | 14 hits — all false positives: `AKIAIOSFODNN7EXAMPLE` in docs (7×), `123e4567-…` UUIDs in test fixtures (6×), one UUID in test_study_lifecycle.py; triaged in Task 4 |
