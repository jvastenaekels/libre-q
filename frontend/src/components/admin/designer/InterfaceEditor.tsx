    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
                Customize the buttons and labels of the interface to match your study's tone
                (e.g., changing "Agree/Disagree" to "Like/Dislike").
            </p>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-4 pl-6 border-l-2 border-emerald-100">
                             <div className="space-y-2">
                                <Label className="text-xs text-muted-foreground">Rough Sort Label</Label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <Label className="text-xs text-muted-foreground">Fine Sort Legend</Label>
                                <Input
                                    placeholder="Default: Most Agree"
                                    value={getLabel('fine.legend.agree')}
                                    onChange={(e) => updateLabel('fine.legend.agree', e.target.value)}
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 pl-6 border-l-2 border-red-100">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => updateLabel('fine.legend.disagree', e.target.value)}
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => updateLabel('fine.legend.neutral', e.target.value)}
                                />
                            </div>
                        </div>
                    </div>
